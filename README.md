...
This command will download place the datasetat the following path: `./data/datasets`.
...
You can train a ResNet18 model using the following command:
...
To see more information about the command line arguments run the command:

```console
python3 -m utils.trainer -h
```
